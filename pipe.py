...
# Staff 流程
staff_personality = [3,5,3,1,3,2],[1,1,1,1,1,1],[5,5,5,5,5,5],[5,5,5,1,1,1],[1,1,1,5,5,5]
def staff_pipeline(event, manager_directive,num_staff):
    response = ollama.generate(model="qwen2.5:7b",prompt=f""" 
    現在，請根據以下參數執行模擬並輸出結果：
